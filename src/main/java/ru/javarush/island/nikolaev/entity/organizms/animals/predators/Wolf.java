...
@Setting(name = "Волк", icon = "\uD83D\uDC3A", maxWeight = 50, maxCount = 30, maxSpeed = 3, maxFood = 8, idFromTheSpecTable = 0)

public class Wolf extends Predator {


    public Wolf(String name, String icon, double weight, int idFromTheSpecTable, Limit limit) {
